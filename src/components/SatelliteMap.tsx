  ...
  loading: () => (
    <div className="w-full h-full min-h-[300px] rounded-2xl bg-slate-950 flex flex-col items-center justify-center text-white/70 gap-3 border border-white/10">
      ...
      <div className="text-center">
        <div className="text-xs font-bold text-slate-200 tracking-wide">Acquiring Real World Satellite Tiles...</div>
        <div className="text-[10px] text-slate-400 font-mono mt-0.5">Google Satellite & Aerial Telemetry</div>
      </div>
    </div>
  ),
});
